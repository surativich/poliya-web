...
import { Package, BarChart3, History, Settings, ChevronRight, Wallet, ShieldCheck } from "lucide-react";
...
export function AdminClient() {
  const adminLinks = [
    ...
    { name: "Xavfsizlik", description: "Admin va Kassir parollarini (PIN) yangilash", path: "/admin/security", icon: ShieldCheck, color: "text-teal-400", bgColor: "bg-teal-500/10" },
